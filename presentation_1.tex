...
\title[Value OSS]{ Value of Open Source Software :\\ A User Perspective } % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Tapajit Dey} % Your name
\institute[UTK] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
University of Tennessee, Knoxville \\ % Your institution for the title page
\medskip
\textit{tdey2@vols.utk.edu} % Your email address
}
...
\subsection{Subsection Example - Text} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
